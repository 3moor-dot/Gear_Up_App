...
#ifndef GEAR_UP_APP_SWIFT_H
#define GEAR_UP_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="gear_up_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC11gear_up_app11AppDelegate")
...
SWIFT_CLASS("_TtC11gear_up_app17MainFlutterWindow")
